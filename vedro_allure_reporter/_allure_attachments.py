...
def create_memory_attachment(data: bytes, name: str, mime_type: str) -> AllureAttachment:
    ...
    plugin_manager.hook.report_attached_data(body=data, file_name=attachment.source)
    return attachment


def create_text_attachment(text: str, name: str, mime_type: str = "text/plain") -> AllureAttachment:
    """
...
def create_file_attachment(file_path: Union[str, Path], name: str = None, 
    ...
    plugin_manager.hook.report_attached_file(source=file_path, file_name=attachment.source)
    return attachment


def create_screenshot_attachment(screenshot_data: bytes, name: str = "Screenshot") -> AllureAttachment:
    """
...
def add_attachment_to_step(step_result, attachment: AllureAttachment) -> None:
    """
    ...
    """
    if not hasattr(step_result, 'attachments') or step_result.attachments is None:
