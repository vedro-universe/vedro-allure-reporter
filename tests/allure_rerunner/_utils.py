...
from vedro_allure_reporter.allure_rerunner import AllureRerunner, AllureRerunnerPlugin
from vedro_allure_reporter.allure_rerunner import AllureRerunnerScenarioScheduler as Scheduler
from vedro_allure_reporter.allure_rerunner._allure_rerunner import SleepType
...
@pytest.fixture()
def allure_rerunner(dispatcher: Dispatcher, sleep_: SleepType) -> AllureRerunnerPlugin:
    plugin = AllureRerunnerPlugin(AllureRerunner, sleep=sleep_)
...
async def fire_arg_parsed_event(dispatcher: Dispatcher, *,
    ...
    arg_parsed_event = ArgParsedEvent(Namespace(allure_reruns=reruns,
                                                allure_reruns_delay=reruns_delay))
